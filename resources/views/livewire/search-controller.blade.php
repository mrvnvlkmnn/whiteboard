                        ...
                        <table class="table min-w-full divide-y divide-gray-200">
                            ...
                            <tr class="tableColored">
                                ...
                                <td style="display: flex; justify-content: flex-end;">
                                    ...
                                    <a class="cursor ml-1" wire:click="$emit('showComponent', 'Details', {{ $survey->id }})">
                                        <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="none">
                                            <path stroke="#C53030" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 13l-7 7-7-7m14-8l-7 7-7-7" />
                                        </svg>
                                    </a>
                                </td>
                            </tr>
