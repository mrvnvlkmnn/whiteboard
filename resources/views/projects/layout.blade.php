...
<div>
    <nav class="flex items-center justify-between flex-wrap bg-eae-dark p-2">
        ...
        <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
            <div class="text-sm lg:flex-grow">
                <a href="projects/create" class="block mt-0 lg:inline-block lg:mt-0 text-eae-light hover:text-white mr-4">
                    Projekt hinzufügen
                </a>
